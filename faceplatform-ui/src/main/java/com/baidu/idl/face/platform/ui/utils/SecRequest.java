...
public class SecRequest {
    ...
    private static final String REQUEST_URL = "https://aip.baidubce.com/rest/2.0/face/v3/person/verify";
    ...
    public static void sendMessage(final Context context, final String secBase64, final int secType) {
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    JSONObject jsonObject = new JSONObject();
                    jsonObject.put("access_token", "24.4b751c0ec563309da71a3aa85d43236f.2592000.1656486335.282335-26278103");
    ...
    private static String requestPost(String paramStr, String requestUrl) {
        ...
        try {
            ...
            if (HttpURLConnection.HTTP_OK == responseCode) {
                ...
                baos.flush();
                Log.e("guo", "request data " + resultData);
            }
        } catch (MalformedURLException e) {
            Log.e("guo", "MalformedURLException " + e.getMessage());
            e.printStackTrace();
        } catch (IOException e) {
            Log.e("guo", "IOException " + e.getMessage());
            e.printStackTrace();
        } catch (Exception e) {
            Log.e("guo", "Exception " + e.getMessage());
            e.printStackTrace();
        } finally {
            try {
