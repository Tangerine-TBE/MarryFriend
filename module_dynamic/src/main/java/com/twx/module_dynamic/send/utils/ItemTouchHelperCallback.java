package com.twx.module_dynamic.send.utils;
...
public class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE && isNeedDragVibrate) {
            VibratorUtil.vibrate(BaseApplication.application.getApplicationContext(), 100);
        }
        //设置拖拽动画
    ...
    public void onChildDraw(Canvas c, @NonNull RecyclerView
        ...
        int editTextHeight = ConvertUtils.dp2px(130);//输入框的高度
        int deleteViewHeight = ConvertUtils.dp2px(50);//删除区间的高度
