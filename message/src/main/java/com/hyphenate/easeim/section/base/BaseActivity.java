...
public class BaseActivity extends AppCompatActivity {
    ...
    private void showExceptionDialog(String accountEvent) {
        ...
        logoutDialog = new AlertDialog.Builder(mContext)
                ...
                .setPositiveButton(com.hyphenate.easeui.R.string.ok, new DialogInterface.OnClickListener() {
                    @Override
    ...
    private int getExceptionMessageId(String exceptionType) {
        ...
        return com.hyphenate.easeui.R.string.Network_error;
    }
    ...
    public static void setToolbarCustomColor(AppCompatActivity mContext, int colorId) {
        Drawable leftArrow = ContextCompat.getDrawable(mContext, com.hyphenate.easeui.R.drawable.abc_ic_ab_back_material);
        if(leftArrow != null) {
