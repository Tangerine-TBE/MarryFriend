    ...
    public void onMessageRecalled(List<EMMessage> messages) {
        ...
        for (EMMessage msg : messages) {
            ...
            if( (!TextUtils.isEmpty(recaller))&&!TextUtils.equals(recaller, from)) {
                text = String.format(context.getString(com.hyphenate.easeui.R.string.msg_recall_by_another), recaller, from);
            }else{
                text = String.format(context.getString(com.hyphenate.easeui.R.string.msg_recall_by_user), from);
            }
