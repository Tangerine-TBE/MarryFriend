...
public class ImageGridFragment extends BaseFragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				com.hyphenate.easeui.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				com.hyphenate.easeui.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(com.hyphenate.easeui.R.drawable.em_empty_photo);
	...
	private class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
		...
		public void onBindViewHolder(@NonNull ImageAdapter.ViewHolder holder, int position) {
			...
			holder.imageView.setImageResource(com.hyphenate.easeui.R.drawable.em_empty_photo);
