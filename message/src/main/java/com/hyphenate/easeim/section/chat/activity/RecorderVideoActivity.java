...
public class RecorderVideoActivity extends EaseBaseActivity implements
	...
	public void onClick(View view) {
		...
		if (id == R.id.switch_btn) {
			...
			if (!startRecording())
				return;
			Toast.makeText(this, com.hyphenate.easeui.R.string.The_video_to_start, Toast.LENGTH_SHORT).show();
			...
			new AlertDialog.Builder(this)
					.setMessage(com.hyphenate.easeui.R.string.Whether_to_send)
					.setPositiveButton(com.hyphenate.easeui.R.string.ok,
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			String st3 = getResources().getString(com.hyphenate.easeui.R.string.Whether_to_send);
			new AlertDialog.Builder(this)
					.setMessage(st3)
					.setPositiveButton(com.hyphenate.easeui.R.string.ok,
							new DialogInterface.OnClickListener() {
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this)
				.setTitle(com.hyphenate.easeui.R.string.prompt)
				.setMessage(com.hyphenate.easeui.R.string.Open_the_equipment_failure)
				.setPositiveButton(com.hyphenate.easeui.R.string.ok,
						new DialogInterface.OnClickListener() {
