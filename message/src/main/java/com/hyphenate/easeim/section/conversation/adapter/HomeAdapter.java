        ...
        public void setData(Object object, int position) {
            if(object instanceof EMConversation) {
                ...
                listIteaseLayout.setBackground(!TextUtils.isEmpty(item.getExtField())
                                                ? ContextCompat.getDrawable(mContext, com.hyphenate.easeui.R.drawable.ease_conversation_top_bg)
                                                : null);
                ...
                if(item.getType() == EMConversation.EMConversationType.GroupChat) {
                    ...
                    avatar.setImageResource(com.hyphenate.easeui.R.drawable.ease_group_icon);
                    ...
                    avatar.setImageResource(com.hyphenate.easeui.R.drawable.ease_chat_room_icon);
                ...
                if(TextUtils.equals(type, MsgTypeManageEntity.msgType.NOTIFICATION.name())) {
                    avatar.setImageResource(com.hyphenate.easeui.R.drawable.em_system_nofinication);
