...
public class MySeekBar extends View implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        bgPaint.setStrokeWidth(LINE_WIDTH);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int[] mColors = {Color.parseColor("#FF4444"), Color.parseColor("#FF40CC")};
        LinearGradient linearGradient = new LinearGradient(0, 0, getWidth(), 0, mColors, null, Shader.TileMode.MIRROR);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mPoints.length >= 2) {
            ...
            canvas.drawLine(mPoints[0].getX(), mPoints[0].getY(), mPoints[mPoints.length - 1].getX(), mPoints[mPoints.length - 1].getY(), linePaint);
            //画区间线
...
//            canvas.drawOval(mRectF, indicatorPaint);
            ...
            canvas.drawBitmap(getBitmap(R.drawable.ic_seekbar_icon_right),
                    ...
                    mRightCI.getCurY() - getBitmap(R.drawable.ic_seekbar_icon_right).getWidth() / 2,
                    indicatorPaint);
        }
    }
