package com.twx.marryfriend.view.LoadingAnimation;
...
public class AVZipIndicatorView extends View {
    ...
    public AVZipIndicatorView(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public AVZipIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, R.style.AVLoadingIndicatorView);
    }

    public AVZipIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, R.style.AVLoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AVZipIndicatorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
