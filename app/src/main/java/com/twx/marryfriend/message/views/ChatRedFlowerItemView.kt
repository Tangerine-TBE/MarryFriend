...
class ChatRedFlowerItemView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet?=null, defSty:Int=0):
    ...
    private val iSendView by lazy {
        DataBindingUtil.inflate<ViewDataBinding>(
            LayoutInflater.from(this.context), R.layout.item_my_chat_red_flower_msg,this,false)
    }
    private val friendSendView by lazy {
        DataBindingUtil.inflate<ViewDataBinding>(
            LayoutInflater.from(this.context), R.layout.item_friend_chat_red_flower_msg,this,false)
    }
    var chatItemModel: ChatItemModel<SendFlowerMessage>?=null

    fun setData(chatItemModel: ChatItemModel<SendFlowerMessage>){
