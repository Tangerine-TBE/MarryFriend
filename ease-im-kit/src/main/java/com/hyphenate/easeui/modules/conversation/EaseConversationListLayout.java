...
public class EaseConversationListLayout extends EaseBaseLayout implements IConversationListLayout, IConversationStyle
    ...
    public void init() {
        init(new EaseConversationDelegate(setModel));
    }

    public void init(EaseAdapterDelegate conversationDelegate){
        listAdapter.addDelegate(new EaseSystemMsgDelegate(setModel));
        if (conversationDelegate==null){
            conversationDelegate=new EaseConversationDelegate(setModel);
        }
        listAdapter.addDelegate(conversationDelegate);
